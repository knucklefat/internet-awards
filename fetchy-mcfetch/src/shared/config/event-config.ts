...
export const AWARDS: Award[] = [
  // GAMING & HOBBIES (4 awards)
  {
    ...
    nomineeNamePlaceholder: 'e.g. Elden Ring, Baldur\'s Gate 3',
  ...
  },
  {
    ...
    nomineeNamePlaceholder: 'e.g. Art piece title or artist name',
  ...
  // FUNNY & CUTE (4 awards)
  {
    ...
    nomineeNamePlaceholder: 'e.g. Comic title, comedian, or skit name',
    bannerImage: 'internet-awards.gif',
  ...
  },
  {
    ...
    nomineeNamePlaceholder: 'e.g. That breakdancing cat, specific animal or moment',
    bannerImage: 'internet-awards.gif',
