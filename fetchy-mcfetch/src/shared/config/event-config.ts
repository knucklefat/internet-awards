...
export const AWARDS: Award[] = [
  // GAMING & HOBBIES (4 awards)
  {
    ...
    nomineeNamePlaceholder: 'e.g. Elden Ring, Crash Bandicoot, Pong',
  ...
  },
  {
    ...
    resolutionGuidance: 'e.g.Tickle-Me ELmo, GPK Adam Bomb, S.H.Figuarts MONKEY.D.LUFFY  ',
    nomineeNamePlaceholder: 'e.g. Limited edition figure, rare trading card',
  ...
  },
  {
    ...
    nomineeNamePlaceholder: 'e.g. HOPE poster, Dogs Playing Poker',
  ...
  },
  {
    ...
    nomineeNamePlaceholder: 'e.g. Book title, author, or quote source',
  ...
  // FUNNY & CUTE (4 awards)
  {
    ...
    nomineeNamePlaceholder: 'e.g. Jeff Arcuri "dolphins", Katt WIlliams "wut", Autism-Lev fur ',
    bannerImage: 'internet-awards.gif',
  ...
  },
  {
    ...
    nomineeNamePlaceholder: 'e.g. That breakdancing cat, smiling sloth, Babe',
    bannerImage: 'internet-awards.gif',
  ...
  },
  {
    ...
    nomineeNamePlaceholder: 'e.g. Meme name or short description',
    bannerImage: 'internet-awards.gif',
  ...
  },
  {
    ...
    nomineeNamePlaceholder: 'e.g. Title or description of wholesome content',
    bannerImage: 'internet-awards.gif',
  ...
  // KNOWLEDGE (4 awards)
  {
    ...
    nomineeNamePlaceholder: 'e.g. Thread title, topic, or thought-provoker',
    bannerImage: 'internet-awards.gif',
  ...
  },
  {
    ...
    nomineeNamePlaceholder: 'e.g. Product name, tech, or company',
    bannerImage: 'internet-awards.gif',
  ...
  },
  {
    ...
    emoji: '🔬',
    description: 'Research, discovery, or development in a field of science that nuked noggins',
    resolutionGuidance: 'Title or description of subject',
    nomineeNamePlaceholder: 'e.g. Discovery, research, or development',
    bannerImage: 'internet-awards.gif',
  ...
  },
  {
    ...
    emoji: '🎙️',
    description: 'Most Informative stream of the past year',
    resolutionGuidance: 'Title of a podcast, stream, or streamer',
    nomineeNamePlaceholder: 'e.g. Podcast name, stream title, or streamer',
    bannerImage: 'internet-awards.gif',
  ...
  // LIFESTYLE & ADVICE (4 awards)
  {
    ...
    nomineeNamePlaceholder: 'e.g. Life hack or tip in a few words',
    bannerImage: 'internet-awards.gif',
  ...
  },
  {
    ...
    nomineeNamePlaceholder: 'e.g. City, country, or landmark',
    bannerImage: 'internet-awards.gif',
  ...
  },
  {
    ...
    nomineeNamePlaceholder: 'e.g. Style trend, brand, or look name',
    bannerImage: 'internet-awards.gif',
  ...
  },
  {
    ...
    nomineeNamePlaceholder: 'e.g. Recipe name, dish, or drink',
    bannerImage: 'internet-awards.gif',
  ...
  // POP CULTURE (4 awards)
  {
    ...
    nomineeNamePlaceholder: 'e.g. Show name, episode, or story arc',
    bannerImage: 'internet-awards.gif',
  ...
  },
  {
    ...
    nomineeNamePlaceholder: 'e.g. Movie title',
    bannerImage: 'internet-awards.gif',
  ...
  },
  {
    ...
    nomineeNamePlaceholder: 'e.g. Team, player, game, or moment',
    bannerImage: 'internet-awards.gif',
  ...
  },
  {
    ...
    nomineeNamePlaceholder: 'e.g. Song title or artist',
    bannerImage: 'internet-awards.gif',
  ...
  // THE INTERNET (4 awards)
  {
    ...
    nomineeNamePlaceholder: 'e.g. r/subreddit or community name',
    bannerImage: 'internet-awards.gif',
  ...
  },
  {
    ...
    nomineeNamePlaceholder: 'e.g. Podcast, channel, or creator name',
    bannerImage: 'internet-awards.gif',
  ...
  },
  {
    ...
    nomineeNamePlaceholder: 'e.g. Trend name or short description',
    bannerImage: 'internet-awards.gif',
  ...
  },
  {
    ...
    emoji: '💭',
    description: 'The Reddit AMA most worth reading',
    resolutionGuidance: 'Title or name or reddit post title',
    nomineeNamePlaceholder: 'e.g. AMA title or guest name',
    bannerImage: 'internet-awards.gif',
...
export const INTERNET_AWARDS_EVENT: EventConfig = {
  ...
  description: 'Celebrating the best of Reddit - 24 Awards in 6 categories',
