...
export const AWARD_CATEGORIES: AwardCategory[] = [
  // GAMING & HOBBIES (4 awards)
  {
    ...
    name: 'S-Tier Game',
    emoji: '🎮',
    description: 'Video game. Title on any digital platform.',
  ...
  // KNOWLEDGE (4 awards)
  {
    ...
    emoji: '🤯',
    description: 'A factual subject or event.',
    bannerImage: 'internet-awards.gif',
  ...
  },
  {
    ...
    emoji: '🎙️',
    description: 'Most informative episode (Podcast/Video/Stream) this past year.',
    bannerImage: 'internet-awards.gif',
